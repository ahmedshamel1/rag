...
def create_multi_role_document_manager(folder_name: str) -> BakersDocumentManager:
    """
    ...
    Returns:
        BakersDocumentManager: Configured multi-role document manager
    """
    tracking_file = f"backend/logs/{folder_name}_document_tracking.json"
    return BakersDocumentManager(tracking_file)
